...
!function (e, t, n, i) {
  ...
  e.fn.form = function (t, o) {
    ...
    return r.each(function () {
      var t, o = e(this), l = e(this).find(d.field), w = e(this).find(d.group), C = e(this).find(d.message), k = (e(this).find(d.prompt), e(this).find(d.submit)), T = e(this).find(d.clear), S = e(this).find(d.reset), A = [], P = !1, E = this, F = o.data(g);
      t = {
        initialize: function () {
          ...
          changeEvent: function (e) {
            ...
            var i = e.isArray(n) ? t.get.fields(n) : l, o = {};
            return i.each(function (n, i) {
              var a = e(i), r = (a.prop("type"), a.prop("name")), s = a.val(), c = a.is(d.checkbox), l = a.is(d.radio), u = -1 !== r.indexOf("[]"), f = c ? a.is(":checked") : !1;
              if (r)if (u)if (r = r.replace("[]", ""), o[r] || (o[r] = []), c) {
                if (!f)return t.debug("Omitted unchecked checkbox", a), !0;
                o[r].push(s)
              } else o[r].push(s); else if (l)f && (o[r] = s); else if (c) {
                if (!f)return t.debug("Omitted unchecked checkbox", a), !0;
                o[r] = !0
              } else o[r] = s
            }), o
          ...
          success: function () {
            ...
            e.isEmptyObject(n) || (e.each(n, function (n, i) {
              var o, a = t.get.field(n), r = a.parent(), s = e.isArray(i), c = r.is(d.uiCheckbox), l = r.is(d.uiDropdown), u = a.is(d.radio) && c, f = a.length > 0;
  ...
  e.fn.accordion = function (n) {
    ...
    return a.each(function () {
      var d, f, m = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.accordion.settings, n) : e.extend({}, e.fn.accordion.settings), g = m.className, p = m.namespace, v = m.selector, h = m.error, b = "." + p, y = "module-" + p, x = a.selector || "", w = e(this), C = w.find(v.title), k = w.find(v.content), T = this, S = w.data(y);
      f = {
        initialize: function () {
          ...
          var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title), o = n.next(k), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = r && !a, c = !r && a;
          ...
          var n = t !== i ? "number" == typeof t ? C.eq(t) : e(t).closest(v.title) : e(this).closest(v.title), o = n.next(k), a = o.hasClass(g.animating), r = o.hasClass(g.active), s = !r && !a;
          s && (f.debug("Opening accordion content", n), m.exclusive && f.closeOthers.call(n), n.addClass(g.active), o.addClass(g.animating), m.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
            ...
            verbose: m.verbose,
            duration: m.duration
          }) : o.children().stop(!0).animate({opacity: 1}, m.duration, f.resetOpacity)), o.stop(!0).slideDown(m.duration, m.easing, function () {
          ...
          !r && !s || c || (f.debug("Closing accordion content", o), n.removeClass(g.active), o.addClass(g.animating), m.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? o.children().transition({
            ...
            verbose: m.verbose,
            duration: m.duration
          }) : o.children().stop(!0).animate({opacity: 0}, m.duration, f.resetOpacity)), o.stop(!0).slideUp(m.duration, m.easing, function () {
          ...
          var n, o, a, r = t !== i ? C.eq(t) : e(this).closest(v.title), s = r.parents(v.content).prev(v.title), c = r.closest(v.accordion), l = v.title + "." + g.active + ":visible", u = v.content + "." + g.active + ":visible";
          m.closeNested ? (n = c.find(l).not(s), a = n.next(k)) : (n = c.find(l).not(s), o = c.find(u).find(l).not(s), n = n.not(o), a = n.next(k)), n.length > 0 && (f.debug("Exclusive enabled, closing other content", n), n.removeClass(g.active), m.animateChildren && (e.fn.transition !== i && w.transition("is supported") ? a.children().transition({
            ...
            verbose: m.verbose,
            duration: m.duration
          }) : a.children().stop().animate({opacity: 0}, m.duration, f.resetOpacity)), a.stop().slideUp(m.duration, m.easing, function () {
  ...
  e.fn.checkbox = function (n) {
    ...
    return a.each(function () {
      var a, f, m = e.extend(!0, {}, e.fn.checkbox.settings, n), g = m.className, p = m.namespace, v = m.selector, h = m.error, b = "." + p, y = "module-" + p, x = e(this), w = e(this).find(v.label).first(), C = e(this).find(v.input), k = x.data(y), T = this;
      f = {
        initialize: function () {
          ...
          "MutationObserver"in t && (a = new MutationObserver(function () {
            f.debug("DOM tree modified, updating selector cache"), f.refresh()
          }), a.observe(T, {childList: !0, subtree: !0}), f.debug("Setting up mutation observer", a))
  ...
  e.fn.dimmer = function (t) {
    var o, a = e(this), r = (new Date).getTime(), s = [], c = arguments[0], l = "string" == typeof c, u = [].slice.call(arguments, 1);
    return a.each(function () {
      var d, f, m, g = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.dimmer.settings, t) : e.extend({}, e.fn.dimmer.settings), p = g.selector, v = g.namespace, h = g.className, b = g.error, y = "." + v, x = "module-" + v, w = a.selector || "", C = "ontouchstart"in n.documentElement ? "touchstart" : "click", k = e(this), T = this, S = k.data(x);
      m = {
        preinitialize: function () {
          ...
          opacity: function (e) {
            var e = g.opacity || e, t = d.css("background-color"), n = t.split(","), i = n && 4 == n.length;
  ...
  e.fn.dropdown = function (o) {
    ...
    return r.each(function (p) {
      var v, h, b, y, x = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.dropdown.settings, o) : e.extend({}, e.fn.dropdown.settings), w = x.className, C = x.metadata, k = x.namespace, T = x.selector, S = x.error, A = "." + k, P = "module-" + k, E = e(this), F = E.find(T.text), R = E.find(T.search), O = E.find(T.input), D = E.prev().find(T.text).length > 0 ? E.prev().find(T.text) : E.prev(), z = E.children(T.menu), q = z.find(T.item), j = !1, N = !1, I = this, V = E.data(P);
      y = {
        initialize: function () {
          y.debug("Initializing dropdown", x), y.is.alreadySetup() ? y.setup.reference() : (y.setup.layout(), y.save.defaults(), y.set.selected(), y.create.id(), l && y.bind.touchEvents(), y.bind.mouseEvents(), y.bind.keyboardEvents(), y.observeChanges(), y.instantiate())
        }, instantiate: function () {
          y.verbose("Storing instance of dropdown", y), V = y, E.data(P, y)
        }, destroy: function () {
          y.verbose("Destroying previous dropdown for", E), y.remove.tabbable(), E.off(A).removeData(P), z.off(A), s.off(v)
        }, observeChanges: function () {
          "MutationObserver"in t && (b = new MutationObserver(function (e) {
            y.is.selectMutation(e) ? (y.debug("<select> modified, recreating menu"), y.setup.select()) : (y.debug("DOM tree modified, updating selector cache"), y.refresh())
          }), b.observe(I, {childList: !0, subtree: !0}), y.debug("Setting up mutation observer", b))
        }, create: {
          id: function () {
            h = (Math.random().toString(16) + "000000000").substr(2, 8), v = "." + h, y.verbose("Creating unique id for element", h)
          }
        }, search: function () {
          var e;
          e = R.val(), y.verbose("Searching for query", e), y.filter(e), y.is.searchSelection() && y.can.show() && y.show()
        }, setup: {
          layout: function () {
            E.is("select") && y.setup.select(), y.is.search() && !y.is.searchable() && (R = e("<input />").addClass(w.search).insertBefore(F)), x.allowTab && y.set.tabbable()
          }, select: function () {
            var t = y.get.selectValues();
            y.debug("Dropdown initialized on a select", t), E.is("select") && (O = E), O.parent(T.dropdown).length > 0 ? (y.debug("UI dropdown already exists. Creating dropdown menu only"), E = O.closest(T.dropdown), z = E.children(T.menu), 0 === z.length && (z = e("<div />").addClass(w.menu).appendTo(E)), z.html(x.templates.menu(t))) : (y.debug("Creating entire dropdown from select"), E = e("<div />").attr("class", O.attr("class")).addClass(w.selection).addClass(w.dropdown).html(x.templates.dropdown(t)).insertBefore(O), O.removeAttr("class").prependTo(E)), y.setup.reference()
          }, reference: function () {
            var e, t;
            y.debug("Dropdown behavior was called on select, replacing with closest dropdown"), E = E.closest(T.dropdown), y.refresh(), e = r.slice(0, p), t = r.slice(p + 1), r = e.add(E).add(t)
          }
        }, refresh: function () {
          y.verbose("Refreshing selector cache"), F = E.find(T.text), R = E.find(T.search), O = E.find(T.input), D = E.prev().find(T.text).length > 0 ? E.prev().find(T.text) : E.prev(), z = E.children(T.menu), q = z.find(T.item)
        }, toggle: function () {
          y.verbose("Toggling menu visibility"), y.is.active() ? y.hide() : y.show()
        }, show: function (t) {
          t = e.isFunction(t) ? t : function () {
          }, y.is.searchSelection() && y.is.allFiltered() || y.can.show() && !y.is.active() && (y.debug("Showing dropdown"), y.animate.show(function () {
            y.can.click() && y.bind.intent(), y.set.visible(), t.call(I)
          }), x.onShow.call(I))
        }, hide: function (t) {
          t = e.isFunction(t) ? t : function () {
          }, y.is.active() && (y.debug("Hiding dropdown"), y.animate.hide(function () {
            y.remove.visible(), t.call(I)
          }), x.onHide.call(I))
        }, hideOthers: function () {
          y.verbose("Finding other dropdowns to hide"), r.not(E).has(T.menu + ":visible:not(." + w.animating + ")").dropdown("hide")
        }, hideSubMenus: function () {
          var e = z.find(T.menu);
          e.transition("hide")
        }, bind: {
          keyboardEvents: function () {
            y.debug("Binding keyboard events"), E.on("keydown" + A, y.event.keydown), y.is.searchable() && E.on(y.get.inputEvent(), T.search, y.event.input)
          }, touchEvents: function () {
            y.debug("Touch device detected binding additional touch events"), y.is.searchSelection() || E.on("touchstart" + A, y.event.test.toggle), z.on("touchstart" + A, T.item, y.event.item.mouseenter)
          }, mouseEvents: function () {
            y.verbose("Mouse detected binding mouse events"), y.is.searchSelection() ? E.on("mousedown" + A, T.menu, y.event.menu.activate).on("mouseup" + A, T.menu, y.event.menu.deactivate).on("click" + A, T.search, y.show).on("focus" + A, T.search, y.event.searchFocus).on("blur" + A, T.search, y.event.searchBlur).on("click" + A, T.text, y.event.searchTextFocus) : ("click" == x.on ? E.on("click" + A, y.event.test.toggle) : "hover" == x.on ? E.on("mouseenter" + A, y.delay.show).on("mouseleave" + A, y.delay.hide) : E.on(x.on + A, y.toggle), E.on("mousedown" + A, y.event.mousedown).on("mouseup" + A, y.event.mouseup).on("focus" + A, y.event.focus).on("blur" + A, y.event.blur)), z.on("mouseenter" + A, T.item, y.event.item.mouseenter).on("mouseleave" + A, T.item, y.event.item.mouseleave).on("click" + A, T.item, y.event.item.click)
          }, intent: function () {
            y.verbose("Binding hide intent event to document"), l && s.on("touchstart" + v, y.event.test.touch).on("touchmove" + v, y.event.test.touch), s.on("click" + v, y.event.test.hide)
          }
        }, unbind: {
          intent: function () {
            y.verbose("Removing hide intent event from document"), l && s.off("touchstart" + v).off("touchmove" + v), s.off("click" + v)
          }
        }, filter: function (t) {
          var n = e(), i = y.escape.regExp(t), o = new RegExp("^" + i, "igm"), a = new RegExp(i, "ig");
          y.verbose("Searching for matching values"), q.each(function () {
            var t = e(this), i = String(y.get.choiceText(t, !1)), r = String(y.get.choiceValue(t, i));
            i.match(o) || r.match(o) ? n = n.add(t) : x.fullTextSearch && (i.match(a) || r.match(a)) && (n = n.add(t))
          }), y.debug("Setting filter", t), y.remove.filteredItem(), q.not(n).addClass(w.filtered), y.verbose("Selecting first non-filtered element"), y.remove.selectedItem(), q.not("." + w.filtered).eq(0).addClass(w.selected), y.is.allFiltered() && (y.debug("All items filtered, hiding dropdown", t), y.is.searchSelection() && y.hide(), x.onNoResults.call(I, t))
        }, focusSearch: function () {
          y.is.search() && R.focus()
        }, forceSelection: function () {
          var e = q.not(w.filtered).filter("." + w.selected).eq(0), t = q.filter("." + w.active).eq(0), n = e.length > 0 ? e : t, i = n.size() > 0;
          i && (y.event.item.click.call(n), y.remove.filteredItem())
        }, event: {
          mousedown: function () {
            j = !0
          }, mouseup: function () {
            ...
            var e = n.activeElement === this;
            N || e || (x.forceSelection ? y.forceSelection() : y.hide())
          }, searchTextFocus: function () {
            j = !0, R.focus()
          }, input: function () {
            y.is.searchSelection() && y.set.filtered(), clearTimeout(y.timer), y.timer = setTimeout(y.search, x.delay.search)
          }, keydown: function (e) {
            {
              var t, n = q.not(w.filtered).filter("." + w.selected).eq(0), i = z.children("." + w.active).eq(0), o = n.length > 0 ? n : i, a = o.length > 0 ? o.siblings(":not(." + w.filtered + ")").andSelf() : z.children(":not(." + w.filtered + ")"), r = o.children(T.menu), s = o.closest(T.menu), c = s[0] !== z[0], l = s.is(":visible"), u = e.which, d = {
                enter: 13,
                escape: 27,
                leftArrow: 37,
                upArrow: 38,
            ...
            if (y.is.visible()) {
              if (u == d.enter && m && (f && !x.allowCategorySelection ? (y.verbose("Pressed enter on unselectable category, opening sub menu"), u = d.rightArrow) : (y.verbose("Enter key pressed, choosing selected item"), y.event.item.click.call(o, e))), u == d.leftArrow && (c && (y.verbose("Left key pressed, closing sub-menu"), y.animate.hide(!1, s), o.removeClass(w.selected), s.closest(T.item).addClass(w.selected)), e.preventDefault()), u == d.rightArrow && (f && (y.verbose("Right key pressed, opening sub-menu"), y.animate.show(!1, r), o.removeClass(w.selected), r.find(T.item).eq(0).addClass(w.selected)), e.preventDefault()), u == d.upArrow) {
                if (t = m && l ? o.prevAll(T.item + ":not(." + w.filtered + ")").eq(0) : q.eq(0), a.index(t) < 0)return void y.verbose("Up key pressed but reached top of current menu");
                y.verbose("Up key pressed, changing active item"), o.removeClass(w.selected), t.addClass(w.selected), y.set.scrollPosition(t), e.preventDefault()
              }
              if (u == d.downArrow) {
                if (t = m && l ? t = o.nextAll(T.item + ":not(." + w.filtered + ")").eq(0) : q.eq(0), 0 === t.length)return void y.verbose("Down key pressed but reached bottom of current menu");
                y.verbose("Down key pressed, changing active item"), q.removeClass(w.selected), t.addClass(w.selected), y.set.scrollPosition(t), e.preventDefault()
              }
            } else u == d.enter && (y.verbose("Enter key pressed, showing dropdown"), y.show()), u == d.escape && (y.verbose("Escape key pressed, closing dropdown"), y.hide()), u == d.downArrow && (y.verbose("Down key pressed, showing dropdown"), y.show())
          }, test: {
            toggle: function (e) {
              y.determine.eventInMenu(e, y.toggle) && e.preventDefault()
            }, touch: function (e) {
              y.determine.eventInMenu(e, function () {
                "touchstart" == e.type ? y.timer = setTimeout(y.hide, x.delay.touch) : "touchmove" == e.type && clearTimeout(y.timer)
              }), e.stopPropagation()
            }, hide: function (e) {
            ...
            mouseenter: function (t) {
              ...
              n.length > 0 && (clearTimeout(y.itemTimer), y.itemTimer = setTimeout(function () {
                y.verbose("Showing sub-menu", n), e.each(i, function () {
                  y.animate.hide(!1, e(this))
                }), y.animate.show(!1, n)
              }, x.delay.show), t.preventDefault())
            }, mouseleave: function () {
              var t = e(this).children(T.menu);
              t.length > 0 && (clearTimeout(y.itemTimer), y.itemTimer = setTimeout(function () {
                y.verbose("Hiding sub-menu", t), y.animate.hide(!1, t)
              }, x.delay.hide))
            }, click: function (t) {
              var n = e(this), i = e(t ? t.target : ""), o = n.find(T.menu), a = y.get.choiceText(n), r = y.get.choiceValue(n, a), s = function () {
                y.remove.searchTerm(), y.determine.selectAction(a, r)
              }, c = o.length > 0, l = o.find(i).length > 0;
              l || c && !x.allowCategorySelection || s()
            }
          }, resetStyle: function () {
          ...
          selectAction: function (t, n) {
            y.verbose("Determining action", x.action), e.isFunction(y.action[x.action]) ? (y.verbose("Triggering preset action", x.action, t, n), y.action[x.action](t, n)) : e.isFunction(x.action) ? (y.verbose("Triggering user action", x.action, t, n), x.action(t, n)) : y.error(S.action, x.action)
          }, eventInModule: function (t, n) {
            return n = e.isFunction(n) ? n : function () {
            }, 0 === e(t.target).closest(E).length ? (y.verbose("Triggering event", n), n(), !0) : (y.verbose("Event occurred in dropdown, canceling callback"), !1)
          }, eventInMenu: function (t, n) {
            return n = e.isFunction(n) ? n : function () {
            }, 0 === e(t.target).closest(z).length ? (y.verbose("Triggering event", n), n(), !0) : (y.verbose("Event occurred in dropdown menu, canceling callback"), !1)
          }
        }, action: {
          nothing: function () {
          }, activate: function (e, t) {
            t = t !== i ? t : e, y.set.selected(t), y.hide(function () {
          ...
          id: function () {
            ...
            return O.length > 0 ? O.val() : E.data(C.value)
          }, choiceText: function (e, t) {
            return t = t !== i ? t : x.preserveHTML, e !== i ? (e.find(T.menu).length > 0 && (y.verbose("Retreiving text of element with sub-menu"), e = e.clone(), e.find(T.menu).remove(), e.find(T.menuIcon).remove()), e.data(C.text) !== i ? e.data(C.text) : t ? e.html().trim() : e.text().trim()) : void 0
          }, choiceValue: function (e, t) {
            return t = t || y.get.choiceText(e), e.data(C.value) !== i ? e.data(C.value) : "string" == typeof t ? t.toLowerCase().trim() : t.trim()
          }, inputEvent: function () {
            var e = R[0];
            return e ? e.oninput !== i ? "input" : e.onpropertychange !== i ? "propertychange" : "keyup" : !1
          }, selectValues: function () {
            var t = {};
            return t.values = x.sortSelect ? {} : [], E.find("option").each(function () {
              var n = e(this).html(), o = e(this).attr("value") !== i ? e(this).attr("value") : n;
              "" === o ? t.placeholder = n : x.sortSelect ? t.values[o] = {name: n, value: o} : t.values.push({
                name: n,
                value: o
              })
            }), x.sortSelect ? y.debug("Retrieved and sorted values from select", t) : y.debug("Retreived values from select", t), t
          }, activeItem: function () {
            return q.filter("." + w.active)
          }, item: function (t, n) {
            var o = !1;
            return t = t !== i ? t : y.get.value() !== i ? y.get.value() : y.get.text(), n = "" === t || 0 === t ? !0 : n || !1, t !== i ? q.each(function () {
              var i = e(this), a = y.get.choiceText(i), r = y.get.choiceValue(i, a);
              n ? (y.verbose("Ambiguous dropdown value using strict type check", i, t), r === t ? o = e(this) : o || a !== t || (o = e(this))) : r == t ? (y.verbose("Found select item by value", r, t), o = e(this)) : o || a != t || (y.verbose("Found select item by text", a, t), o = e(this))
            }) : t = y.get.text(), o || !1
          }
        }, restore: {
          defaults: function () {
            y.restore.defaultText(), y.restore.defaultValue()
          }, defaultText: function () {
            var e = E.data(C.defaultText);
            y.debug("Restoring default text", e), y.set.text(e), F.addClass(w.placeholder)
          }, defaultValue: function () {
            var e = E.data(C.defaultValue);
            e !== i && (y.debug("Restoring default value", e), e.length ? y.set.selected(e) : (y.remove.activeItem(), y.remove.selectedItem()))
          }
        }, save: {
          defaults: function () {
            y.save.defaultText(), y.save.placeholderText(), y.save.defaultValue()
          }, defaultValue: function () {
            E.data(C.defaultValue, y.get.value())
          }, defaultText: function () {
            E.data(C.defaultText, F.text())
          }, placeholderText: function () {
            F.hasClass(w.placeholder) && E.data(C.placeholderText, F.text())
          }
        }, clear: function () {
          var e = E.data(C.placeholderText);
          y.set.text(e), y.set.value(""), y.remove.activeItem(), y.remove.selectedItem(), F.addClass(w.placeholder)
        }, set: {
          filtered: function () {
            var e = R.val(), t = "string" == typeof e && e.length > 0;
            t ? F.addClass(w.filtered) : F.removeClass(w.filtered)
          }, tabbable: function () {
            y.is.searchable() ? (y.debug("Searchable dropdown initialized"), R.val("").attr("tabindex", 0), z.attr("tabindex", "-1")) : (y.debug("Simple selection dropdown initialized"), E.attr("tabindex") || (E.attr("tabindex", 0), z.attr("tabindex", "-1")))
          }, scrollPosition: function (e, t) {
            var n, o, a, r, s, c, l, u, d, f = 5;
            e = e || y.get.activeItem(), n = e && e.length > 0, t = t !== i ? t : !1, e && n && (z.hasClass(w.visible) || z.addClass(w.loading), l = z.height(), a = e.height(), c = z.scrollTop(), s = z.offset().top, r = e.offset().top, o = c - s + r, d = o + f > c + l, u = c > o - f, y.debug("Scrolling to active item", o), (u || d || t) && z.scrollTop(o).removeClass(w.loading))
          }, text: function (e) {
            "combo" == x.action ? (y.debug("Changing combo button text", e, D), x.preserveHTML ? D.html(e) : D.text(e)) : "select" !== x.action && (y.debug("Changing text", e, F), F.removeClass(w.filtered).removeClass(w.placeholder), x.preserveHTML ? F.html(e) : F.text(e))
          }, value: function (e) {
            y.debug("Adding selected value to hidden input", e, O), O.length > 0 ? O.val(e).trigger("change") : E.data(C.value, e)
          }, active: function () {
            E.addClass(w.active)
          }, visible: function () {
            E.addClass(w.visible)
          }, selected: function (e) {
            var t, n, i = y.get.item(e);
            i && (y.debug("Setting selected menu item to", i), y.remove.activeItem(), y.remove.selectedItem(), i.addClass(w.active).addClass(w.selected), t = y.get.choiceText(i), n = y.get.choiceValue(i, t), y.set.text(t), y.set.value(n), x.onChange.call(I, e, t, i))
          }
        }, remove: {
          active: function () {
            E.removeClass(w.active)
          }, visible: function () {
            E.removeClass(w.visible)
          }, activeItem: function () {
            q.removeClass(w.active)
          }, filteredItem: function () {
            q.removeClass(w.filtered)
          }, searchTerm: function () {
            R.val("")
          }, selectedItem: function () {
            q.removeClass(w.selected)
          }, tabbable: function () {
            y.is.searchable() ? (y.debug("Searchable dropdown initialized"), R.attr("tabindex", "-1"), z.attr("tabindex", "-1")) : (y.debug("Simple selection dropdown initialized"), E.attr("tabindex", "-1"), z.attr("tabindex", "-1"))
          }
        }, is: {
          active: function () {
            return E.hasClass(w.active)
          }, alreadySetup: function () {
            return E.is("select") && E.parent(T.dropdown).length > 0
          }, animating: function (e) {
            return e ? e.is(":animated") || e.transition && e.transition("is animating") : z.is(":animated") || z.transition && z.transition("is animating")
          }, allFiltered: function () {
            return q.filter("." + w.filtered).length === q.length
          }, hidden: function (e) {
            return e ? e.is(":hidden") : z.is(":hidden")
            ...
            return E.hasClass(w.search)
          }, searchable: function () {
            return R.length > 0
          }, searchSelection: function () {
            return y.is.searchable() && R.parent().is(E)
          }, selection: function () {
            return E.hasClass(w.selection)
          }, upward: function () {
            return E.hasClass(w.upward)
          }, visible: function (e) {
            return e ? e.is(":visible") : z.is(":visible")
          }
        }, can: {
          click: function () {
            return l || "click" == x.on
          }, show: function () {
            return !E.hasClass(w.disabled)
          }
        }, animate: {
          show: function (t, n) {
            var o = n || z, a = n ? function () {
            } : function () {
              y.hideSubMenus(), y.hideOthers(), y.set.active()
            };
            t = e.isFunction(t) ? t : function () {
            }, y.set.scrollPosition(y.get.activeItem(), !0), y.verbose("Doing menu show animation", o), (y.is.hidden(o) || y.is.animating(o)) && ("auto" == x.transition && (x.transition = y.is.upward() ? "slide up" : "slide down", y.verbose("Automatically determining animation based on animation direction", x.transition)), "none" == x.transition ? t.call(I) : e.fn.transition !== i && E.transition("is supported") ? o.transition({
            ...
            }) : "slide down" == x.transition ? (a(), o.hide().clearQueue().children().clearQueue().css("opacity", 0).delay(50).animate({opacity: 1}, x.duration, "easeOutQuad", y.event.resetStyle).end().slideDown(100, "easeOutQuad", function () {
              y.event.resetStyle.call(this), t.call(I)
            })) : "fade" == x.transition ? (a(), o.hide().clearQueue().fadeIn(x.duration, function () {
              y.event.resetStyle.call(this), t.call(I)
            })) : y.error(S.transition, x.transition))
          }, hide: function (t, n) {
            var o = n || z, a = (n ? .9 * x.duration : x.duration, n ? function () {
            } : function () {
              y.can.click() && y.unbind.intent(), y.focusSearch(), y.remove.active()
            });
            t = e.isFunction(t) ? t : function () {
            }, (y.is.visible(o) || y.is.animating(o)) && (y.verbose("Doing menu hide animation", o), "auto" == x.transition && (x.transition = y.is.upward() ? "slide up" : "slide down"), O.trigger("blur"), "none" == x.transition ? t.call(I) : e.fn.transition !== i && E.transition("is supported") ? o.transition({
            ...
            }) : "slide down" == x.transition ? (a(), o.show().clearQueue().children().clearQueue().css("opacity", 1).animate({opacity: 0}, 100, "easeOutQuad", y.event.resetStyle).end().delay(50).slideUp(100, "easeOutQuad", function () {
              y.event.resetStyle.call(this), t.call(I)
            })) : "fade" == x.transition ? (a(), o.show().clearQueue().fadeOut(150, function () {
              y.event.resetStyle.call(this), t.call(I)
            })) : y.error(S.transition))
          }
        }, delay: {
          show: function () {
            y.verbose("Delaying show event to ensure user intent"), clearTimeout(y.timer), y.timer = setTimeout(y.show, x.delay.show)
          }, hide: function () {
            y.verbose("Delaying hide event to ensure user intent"), clearTimeout(y.timer), y.timer = setTimeout(y.hide, x.delay.hide)
          }
        }, escape: {
          regExp: function (e) {
          ...
          if (y.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, x, t); else {
            if (n === i)return x[t];
            x[t] = n
          }
        }, internal: function (t, n) {
          ...
          var r, s, c, l = V;
          return n = n || g, o = I || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
            var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
            if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
              if (l[a] !== i)return s = l[a], !1;
              if (!e.isPlainObject(l[o]) || n == r)return l[o] !== i ? (s = l[o], !1) : (y.error(S.method, t), !1);
              l = l[o]
            }
          })), e.isFunction(s) ? c = s.apply(o, n) : s !== i && (c = s), e.isArray(a) ? a.push(c) : a !== i ? a = [a, c] : c !== i && (a = c), s
        }
      }, m ? (V === i && y.initialize(), y.invoke(f)) : (V !== i && V.invoke("destroy"), y.initialize())
    }), a !== i ? a : r
  ...
  e.fn.modal = function (o) {
    ...
    return r.each(function () {
      var r, h, b, y, x, w, C, k, T, S = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), A = S.selector, P = S.className, E = S.namespace, F = S.error, R = "." + E, O = "module-" + E, D = e(this), z = e(S.context), q = D.find(A.close), j = this, N = D.data(O);
      T = {
        initialize: function () {
          ...
          }), k.observe(j, {childList: !0, subtree: !0}), T.debug("Setting up mutation observer", k))
        }, refresh: function () {
          ...
          t = e.isFunction(t) ? t : function () {
          }, T.debug("Hiding modal"), S.onHide.call(j), (T.is.animating() || T.is.active()) && (S.transition && e.fn.transition !== i && D.transition("is supported") ? (T.remove.active(), D.transition({
            debug: S.debug,
          ...
          t = e.isFunction(t) ? t : function () {
          }, n.length > 0 && (T.debug("Hiding other modals", h), n.modal("hide modal", t, !0))
          ...
          autofocus: function () {
            if (S.autofocus) {
              var e = D.find(":input:visible"), t = e.filter("[autofocus]"), n = t.length > 0 ? t : e;
              n.first().focus()
            }
          }, clickaway: function () {
    ...
    className: {active: "active", animating: "animating", scrolling: "scrolling"}
  }
}(jQuery, window, document), function (e, t, n, i) {
  "use strict";
  e.fn.nag = function (n) {
      ...
      a = {
        initialize: function () {
          ...
          set: function (n, o) {
            ...
            if ("localstorage" == f.storageMethod && t.localStorage !== i)t.localStorage.setItem(n, o), a.debug("Value stored using local storage", n, o); else {
  ...
  e.fn.popup = function (o) {
    var a, r = e(this), s = e(n), c = r.selector || "", l = "ontouchstart"in n.documentElement, u = (new Date).getTime(), d = [], f = arguments[0], m = "string" == typeof f, g = [].slice.call(arguments, 1);
    return r.each(function () {
      var n, r, p, v, h, b = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.popup.settings, o) : e.extend({}, e.fn.popup.settings), y = b.selector, x = b.className, w = b.error, C = b.metadata, k = b.namespace, T = "." + b.namespace, S = "module-" + k, A = e(this), P = e(b.context), E = b.target ? e(b.target) : A, F = e(t), R = e("body"), O = 0, D = !1, z = this, q = A.data(S);
      h = {
        initialize: function () {
          ...
          var t = A.data(C.html) || b.html, i = A.data(C.variation) || b.variation, o = A.data(C.title) || b.title, a = A.data(C.content) || A.attr("title") || b.content;
          ...
          t = e.isFunction(t) ? t : function () {
          }, h.debug("Showing pop-up", b.transition), h.exists() ? b.preserve || b.popup || h.refresh() : h.create(), n && h.set.position() && (h.save.conditions(), b.exclusive && h.hideAll(), h.animate.show(t))
        }, hide: function (t) {
          t = e.isFunction(t) ? t : function () {
          }, h.remove.visible(), h.unbind.close(), h.is.visible() && (h.restore.conditions(), h.animate.hide(t))
        }, hideAll: function () {
          ...
          conditions: function () {
            h.cache = {title: A.attr("title")}, h.cache.title && A.removeAttr("title"), h.verbose("Saving original attributes", h.cache.title)
          }
        }, restore: {
          conditions: function () {
          ...
          show: function (t) {
            t = e.isFunction(t) ? t : function () {
            }, b.transition && e.fn.transition !== i && A.transition("is supported") ? (h.set.visible(), n.transition({
            ...
            t = e.isFunction(t) ? t : function () {
            }, h.debug("Hiding pop-up"), b.transition && e.fn.transition !== i && A.transition("is supported") ? n.transition({
          ...
          id: function () {
            ...
            var n = t !== i ? t[0] : A[0], o = n.parentNode, a = e(o);
          ...
          position: function (o, a) {
            ...
            switch (o = o || A.data(C.position) || b.position, a = a || A.data(C.offset) || b.offset, O == b.maxSearchDepth && b.lastResort && (h.debug("Using last resort position to display", b.lastResort), o = b.lastResort), b.inline && (h.debug("Adding targets margin to calculation"), "left center" == o || "right center" == o ? (a += k, v += -T) : "top left" == o || "top center" == o || "top right" == o ? (a += T, v -= k) : (a += T, v += k)), h.debug("Calculating popup positioning", o), s = o, h.is.rtl() && (s = s.replace(/left|right/g, function (e) {
              ...
              case"top left":
                c = {top: "auto", bottom: p - S.top + v, left: S.left + a, right: "auto"};
                break;
              case"top center":
                c = {bottom: p - S.top + v, left: S.left + u / 2 - f / 2 + a, top: "auto", right: "auto"};
                break;
              case"top right":
                c = {bottom: p - S.top + v, right: g - S.left - u - a, top: "auto", left: "auto"};
                break;
              case"left center":
                c = {top: S.top + d / 2 - m / 2 + a, right: g - S.left + v, left: "auto", bottom: "auto"};
                break;
              case"right center":
                c = {top: S.top + d / 2 - m / 2 + a, left: S.left + u + v, bottom: "auto", right: "auto"};
                break;
              case"bottom left":
                c = {top: S.top + d + v, left: S.left + a, bottom: "auto", right: "auto"};
                break;
              case"bottom center":
                c = {top: S.top + d + v, left: S.left + u / 2 - f / 2 + a, bottom: "auto", right: "auto"};
                break;
              case"bottom right":
                c = {top: S.top + d + v, right: g - S.left - u - a, left: "auto", bottom: "auto"}
            }
  ...
  e.fn.progress = function (t) {
    var o, a = e(this), r = a.selector || "", s = (new Date).getTime(), c = [], l = arguments[0], u = "string" == typeof l, d = [].slice.call(arguments, 1);
    return a.each(function () {
      var a, f, m = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.progress.settings, t) : e.extend({}, e.fn.progress.settings), g = m.className, p = m.metadata, v = m.namespace, h = m.selector, b = m.error, y = "." + v, x = "module-" + v, w = e(this), C = e(this).find(h.bar), k = e(this).find(h.progress), T = e(this).find(h.label), S = this, A = w.data(x), P = !1;
      f = {
        initialize: function () {
  ...
  e.fn.search = function (o) {
    ...
    return e(this).each(function () {
      var m, g = e.extend(!0, {}, e.fn.search.settings, o), p = g.className, v = g.metadata, h = g.regExp, b = g.selector, y = g.error, x = g.namespace, w = "." + x, C = x + "-module", k = e(this), T = k.find(b.prompt), S = k.find(b.searchButton), A = k.find(b.results), P = (k.find(b.result), k.find(b.category), this), E = k.data(C);
      m = {
        initialize: function () {
          ...
          var t, n = k.find(b.result), i = k.find(b.category), o = n.index(n.filter("." + p.active)), a = n.length, r = e.which, s = {
            backspace: 8,
            enter: 13,
            escape: 27,
            upArrow: 38,
          ...
          if (r == s.escape && (m.verbose("Escape key pressed, blurring search field"), T.trigger("blur")), m.is.visible())if (r == s.enter) {
          ...
          local: function (e) {
            ...
            m.set.loading(), m.save.results(n), m.debug("Returned local search results", n), t = m.generateResults({results: n}), m.remove.loading(), m.write.cache(e, {
              html: t,
              results: n
            }), m.addResults(t)
          }, remote: function (t) {
            ...
            var o = [], a = [], r = e.isArray(g.searchFields) ? g.searchFields : [g.searchFields], s = t.replace(h.escape, "\\$&"), c = new RegExp(h.exact + s, "i");
            return n = n || g.source, n === i ? (m.error(y.source), []) : (e.each(r, function (i, r) {
              e.each(n, function (n, i) {
                var s = "string" == typeof i[r], l = -1 == e.inArray(i, o) && -1 == e.inArray(i, a);
  ...
  e.fn.shape = function (o) {
    ...
    return r.each(function () {
      var t, m, g, p = r.selector || "", v = e.extend(!0, {}, e.fn.shape.settings, o), h = v.namespace, b = v.selector, y = v.error, x = v.className, w = "." + h, C = "module-" + h, k = e(this), T = k.find(b.sides), S = k.find(b.side), A = !1, P = this, E = k.data(C);
      g = {
        initialize: function () {
          ...
          transform: {
            up: function () {
              var e = {y: -((t.outerHeight() - m.outerHeight()) / 2), z: -(t.outerHeight() / 2)};
              return {transform: "translateY(" + e.y + "px) translateZ(" + e.z + "px) rotateX(-90deg)"}
            }, down: function () {
              var e = {y: -((t.outerHeight() - m.outerHeight()) / 2), z: -(t.outerHeight() / 2)};
              return {transform: "translateY(" + e.y + "px) translateZ(" + e.z + "px) rotateX(90deg)"}
            }, left: function () {
              var e = {x: -((t.outerWidth() - m.outerWidth()) / 2), z: -(t.outerWidth() / 2)};
              return {transform: "translateX(" + e.x + "px) translateZ(" + e.z + "px) rotateY(90deg)"}
            }, right: function () {
              var e = {x: -((t.outerWidth() - m.outerWidth()) / 2), z: -(t.outerWidth() / 2)};
              return {transform: "translateX(" + e.x + "px) translateZ(" + e.z + "px) rotateY(-90deg)"}
            }, over: function () {
              var e = {x: -((t.outerWidth() - m.outerWidth()) / 2)};
          ...
          above: function () {
            var e = {
              ...
              depth: {active: m.outerHeight() / 2, next: t.outerHeight() / 2}
            };
            g.verbose("Setting the initial animation position as above", m, e), t.css({transform: "rotateY(0deg) translateZ(" + e.depth.active + "px)"}), m.addClass(x.animating).css({
              display: "block",
              top: e.origin + "px",
            ...
            g.verbose("Setting the initial animation position as below", m, e), t.css({transform: "rotateY(0deg) translateZ(" + e.depth.active + "px)"}), m.addClass(x.animating).css({
              display: "block",
              top: e.origin + "px",
              transform: "rotateX(-90deg) translateZ(" + e.depth.next + "px)"
            })
            ...
            var e = {
              ...
              depth: {active: m.outerWidth() / 2, next: t.outerWidth() / 2}
            };
            g.verbose("Setting the initial animation position as left", m, e), t.css({transform: "rotateY(0deg) translateZ(" + e.depth.active + "px)"}), m.addClass(x.animating).css({
              display: "block",
              left: e.origin + "px",
            ...
            g.verbose("Setting the initial animation position as behind", m, e), t.css({transform: "rotateY(0deg)"}), m.addClass(x.animating).css({
              display: "block",
              left: e.origin + "px",
  ...
  e.fn.sidebar = function (o) {
    ...
    return r.each(function () {
      var r, b, y, x, w, C, k = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), T = k.selector, S = k.className, A = k.namespace, P = k.regExp, E = k.error, F = "." + A, R = "module-" + A, O = e(this), D = e(k.context), z = O.children(T.sidebar), q = D.children(T.fixed), j = D.children(T.pusher), N = this, I = O.data(R);
      C = {
        initialize: function () {
          ...
          bodyCSS: function () {
            var t, n = O.outerWidth(), i = O.outerHeight(), o = C.get.direction(), a = {
              left: n,
              right: -n,
              top: i,
              bottom: -i
          ...
          if (t = e.isFunction(t) ? t : function () {
            ...
            if (C.refreshSidebars(), k.overlay && (C.error(E.overlay), k.transition = "overlay"), C.refresh(), C.othersActive())if (C.debug("Other sidebars currently visible"), k.exclusive) {
          ...
          t = e.isFunction(t) ? t : function () {
          }, (C.is.visible() || C.is.animating()) && (C.debug("Hiding sidebar", t), C.refreshSidebars(), n(function () {
          ...
          var t = z.not(O).filter("." + S.visible), n = t.length, i = 0;
          e = e || function () {
          ...
          var n, i, o = C.get.transition(), a = "safe" == o ? D : "overlay" === o || C.othersActive() ? O : j;
          t = e.isFunction(t) ? t : function () {
          }, "scale down" == k.transition && C.scrollToTop(), C.set.transition(o), C.repaint(), n = function () {
          ...
          var n, i, o = C.get.transition(), a = "safe" == o ? D : "overlay" == o || C.othersActive() ? O : j;
          t = e.isFunction(t) ? t : function () {
          }, C.verbose("Removing context push state", C.get.direction()), C.set.transition(o), C.unbind.clickaway(), C.unbind.scrollLock(), n = function () {
          ...
          var n = O.width(), i = C.get.direction(), o = {};
          n = n || O.width(), t = e.isFunction(t) ? t : function () {
          }, o[i] = n, C.debug("Using javascript to push context", o), C.set.visible(), C.set.transition(), C.set.animating(), k.dimPage && j.addClass(S.dimmed), D.css("position", "relative").animate(o, k.duration, k.easing, function () {
            C.remove.animating(), C.bind.clickaway(), t.call(N)
          })
        }, legacyPullPage: function (t) {
          var n = 0, i = C.get.direction(), o = {};
          n = n || O.width(), t = e.isFunction(t) ? t : function () {
          }, o[i] = "0px", C.debug("Using javascript to pull context", o), C.unbind.clickaway(), C.set.animating(), C.remove.visible(), k.dimPage && !C.othersActive() && j.removeClass(S.dimmed), D.css("position", "relative").animate(o, k.duration, k.easing, function () {
          ...
          if (C.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, k, t); else {
            if (n === i)return k[t];
            k[t] = n
          }
        }, internal: function (t, n) {
      ...
      m = {
        initialize: function () {
          ...
          scroll: function (e) {
            ...
            }, n = {offset: a.offset(), height: a.outerHeight(), bottomPadding: parseInt(a.css("padding-bottom"), 10)};
            m.cache = {
          ...
          offset: function () {
            ...
            "HTML" === e || "body" == e ? C = x.offsetParent() : (m.debug("Settings container size", m.cache.context.height), Math.abs(C.height() - m.cache.context.height) > 5 && C.css({height: m.cache.context.height}))
          }, scroll: function (e) {
  ...
  e.fn.tab = function (n) {
    ...
    return r.each(function () {
      var n, g, p, v, h, b = s.className, y = s.metadata, x = s.selector, w = s.error, C = "." + s.namespace, k = "module-" + s.namespace, T = e(this), S = {}, A = !0, P = 0, E = this, F = T.data(k);
      o = {
        initialize: function () {
          ...
          auto: function () {
            ...
            o.verbose("Setting up automatic tab retrieval from server", t), e.isPlainObject(s.apiSettings) ? s.apiSettings.url = t : s.apiSettings = {url: t}
          }, state: function (t) {
            e.address.value(t)
          }
          ...
          fetch: function (t, n) {
            var a, r, c = o.get.tabElement(t), l = {
              dataType: "html", on: "now", onSuccess: function (e) {
  ...
  e.fn.transition = function () {
    ...
    return a.each(function (t) {
      var m, g, p, v, h, b, y, x, w, C, k, T = e(this), S = this;
      k = {
        initialize: function () {
          ...
          var e = T.parent(), t = T.next();
          0 === t.length ? T.detach().appendTo(e) : T.detach().insertBefore(t)
        }, repaint: function () {
          k.verbose("Repainting element");
          S.offsetWidth
        }, delay: function (e) {
          var n, o = m.reverse === !0, r = "auto" == m.reverse && k.get.direction() == v.outward;
          ...
          animating: function (e) {
            ...
            var e = k.get.style(), t = k.get.displayType(), n = e + "display: " + t + " !important;";
          ...
          transition: function (t) {
            var n, o, a, r, s, c = T.attr("class"), l = T.prop("tagName"), u = m.animation, d = k.get.transitionExists(u);
            if (d === i || t) {
          ...
          if (k.debug("Changing setting", t, n), e.isPlainObject(t))e.extend(!0, m, t); else {
            if (n === i)return m[t];
            m[t] = n
          }
        }, internal: function (t, n) {
  ...
  e.fn.video = function (n) {
    ...
    return a.each(function () {
      var f, m = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.video.settings, n) : e.extend({}, e.fn.video.settings), g = m.selector, p = m.className, v = m.error, h = m.metadata, b = m.namespace, y = m.templates, x = "." + b, w = "module-" + b, C = (e(t), e(this)), k = C.find(g.placeholder), T = C.find(g.playButton), S = C.find(g.embed), A = this, P = C.data(w);
      f = {
        initialize: function () {
  ...
  e.api = e.fn.api = function (n) {
    ...
    return a.each(function () {
      var t, a, f, m, g, p = e.isPlainObject(n) ? e.extend(!0, {}, e.fn.api.settings, n) : e.extend({}, e.fn.api.settings), v = p.namespace, h = p.metadata, b = p.selector, y = p.error, x = p.className, w = "." + v, C = "module-" + v, k = e(this), T = k.closest(b.form), S = p.stateContext ? e(p.stateContext) : k, A = this, P = S.get(), E = k.data(C);
      g = {
        initialize: function () {
          var e = g.get.event();
          ...
          urlData: function (t, n) {
            ...
            return t && (o = t.match(p.regExp.required), a = t.match(p.regExp.optional), n = n || p.urlData, o && (g.debug("Looking for required URL variables", o), e.each(o, function (o, a) {
              var r = -1 !== a.indexOf("$") ? a.substr(2, a.length - 3) : a.substr(1, a.length - 2), s = e.isPlainObject(n) && n[r] !== i ? n[r] : k.data(r) !== i ? k.data(r) : S.data(r) !== i ? S.data(r) : n[r];
              ...
              var r = -1 !== a.indexOf("$") ? a.substr(3, a.length - 4) : a.substr(2, a.length - 3), s = e.isPlainObject(n) && n[r] !== i ? n[r] : k.data(r) !== i ? k.data(r) : S.data(r) !== i ? S.data(r) : n[r];
          ...
          trigger: function (e) {
            ...
            complete: function (e) {
              ...
              if (n !== i)if (n.readyState !== i && 4 == n.readyState) {
                if (200 != n.status && a !== i && "" !== a)g.error(y.statusMessage + a, t.url); else if ("error" == o && "json" == p.dataType)try {
  ...
  e.fn.state = function (t) {
    ...
    return a.each(function () {
      var n, f = e.isPlainObject(t) ? e.extend(!0, {}, e.fn.state.settings, t) : e.extend({}, e.fn.state.settings), m = f.error, g = f.metadata, p = f.className, v = f.namespace, h = f.states, b = f.text, y = "." + v, x = v + "-module", w = e(this), C = this, k = w.data(x);
      n = {
        initialize: function () {
          ...
          state: function () {
            ...
            if (n.allows("active") && n.is.enabled()) {
              if (n.refresh(), e.fn.api !== i)if (t = w.api("get request"), o = w.api("was cancelled"))n.debug("API Request cancelled by beforesend"), f.activateTest = function () {
                return !1
    ...
    return r.each(function () {
      ...
      m = {
        initialize: function () {
          ...
          m.debug("Storing instance", m), w.data(y, m), k = m
        }, destroy: function () {
          ...
          }), r.observe(S, {childList: !0, subtree: !0}), m.debug("Setting up mutation observer", r))
        }, bind: {
          events: function () {
            m.verbose("Binding visibility events to scroll and resize"), x.on("resize" + b, m.event.refresh), C.on("scroll" + b, m.event.scroll)
          }
        }, event: {
          refresh: function () {
            T(m.refresh)
          ...
          cache: function () {
            ...
            e && (m.verbose("Lazy loading image", e), g.observeChanges = !1, m.topVisible(function () {
              m.debug("Image top visible", S), m.precache(e, function () {
                m.set.image(e), g.onTopVisible = !1
              })
            }))
          }, fixed: function () {
            m.verbose("Setting up fixed on element pass"), g.once = !1, g.onTopPassed = function () {
              w.addClass(p.fixed).css({top: g.offset + "px"}), g.transition && e.fn.transition !== i && w.transition(g.transition, g.duration)
            }, g.onTopPassedReverse = function () {
              w.removeClass(p.fixed).css({position: "", top: ""})
            }
          }
        }, set: {
          image: function (t) {
          ...
          var t = m.get.elementCalculations(), n = e || g.onPassing, o = "passing";
          ...
          var t = m.get.elementCalculations(), n = e || g.onTopVisible, o = "topVisible";
          ...
          var t = m.get.elementCalculations(), n = e || g.onBottomVisible, o = "bottomVisible";
          ...
          var t = m.get.elementCalculations(), n = e || g.onTopPassed, o = "topPassed";
          ...
          var t = m.get.elementCalculations(), n = e || g.onBottomPassed, o = "bottomPassed";
          ...
          var t = m.get.elementCalculations(), n = e || g.onPassingReverse, o = "passingReverse";
          ...
          var t = m.get.elementCalculations(), n = e || g.onTopVisibleReverse, o = "topVisibleReverse";
          ...
          var t = m.get.elementCalculations(), n = e || g.onBottomVisibleReverse, o = "bottomVisibleReverse";
          ...
          var t = m.get.elementCalculations(), n = e || g.onTopPassedReverse, o = "topPassedReverse";
          ...
          var t = m.get.elementCalculations(), n = e || g.onBottomPassedReverse, o = "bottomPassedReverse";
          ...
          var n = m.get.elementCalculations(), i = m.get.screenCalculations();
          e = e || !1, e && (g.continuous ? (m.debug("Callback being called continuously", t, n), e.call(S, n, i)) : m.get.occurred(t) || (m.debug("Conditions met", t, n), e.call(S, n, i))), m.save.occurred(t)
        }, remove: {
          occurred: function (e) {
          ...
          calculations: function () {
            ...
            var e, t = m.get.scroll(), n = m.get.lastScroll();
            return e = t > n && n ? "down" : n > t && n ? "up" : "static", m.cache.direction = e, m.cache.direction
          }, elementPosition: function () {
            var e = m.cache.element, t = m.get.screenSize();
            ...
            var e = m.get.screenCalculations(), t = m.get.elementPosition();
            ...
            m.verbose("Saving window position"), m.cache.screen = {height: C.height()}
          }, position: function () {
          ...
          var r, s, c, l = k;
          return n = n || f, o = S || o, "string" == typeof t && l !== i && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (n, o) {
            var a = n != r ? o + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
            if (e.isPlainObject(l[a]) && n != r)l = l[a]; else {
              if (l[a] !== i)return s = l[a], !1;
      ...
      }, d ? (k === i && m.initialize(), m.invoke(u)) : (k !== i && k.invoke("destroy"), m.initialize())
    }), a !== i ? a : this
