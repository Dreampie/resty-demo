...
!function (e, i, n, t) {
  ...
  e.fn.modal = function (o) {
    var a, s = e(this), r = e(i), c = e(n), l = e("body"), u = s.selector || "", d = (new Date).getTime(), m = [], f = arguments[0], g = "string" == typeof f, h = [].slice.call(arguments, 1), v = i.requestAnimationFrame || i.mozRequestAnimationFrame || i.webkitRequestAnimationFrame || i.msRequestAnimationFrame || function (e) {
        setTimeout(e, 0)
      };
    return s.each(function () {
      var s, b, p, y, w, k, S, M, A, C = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.modal.settings, o) : e.extend({}, e.fn.modal.settings), D = C.selector, F = C.className, H = C.namespace, T = C.error, O = "." + H, x = "module-" + H, z = e(this), q = e(C.context), E = z.find(D.close), j = this, N = z.data(x);
      A = {
        initialize: function () {
          ...
          dimmer: function () {
            ...
            }, n = e.extend(!0, i, C.dimmerSettings);
            return e.fn.dimmer === t ? void A.error(T.dimmer) : (A.debug("Creating dimmer with settings", n), y = q.dimmer(n), C.detachable && (A.verbose("Modal is detachable, moving content into dimmer"), y.dimmer("add content", z)), void(w = y.dimmer("get dimmer")))
          }, id: function () {
          ...
          var t = e(i);
          n = e.isFunction(A[n]) ? A[n] : A.toggle, t.length > 0 ? (A.debug("Attaching modal events to element", i, n), t.off(O).on("click" + O, n)) : A.error(T.notFound, i)
        }, bind: {
          events: function () {
          ...
          close: function () {
            ...
            var i = e.which, n = 27;
            i == n && (C.closable ? (A.debug("Escape key pressed hiding modal"), A.hide()) : A.debug("Escape key pressed, but closable is set to false"), e.preventDefault())
          }, resize: function () {
          ...
          }, A.refreshModals(), A.showModal(i)
        }, hide: function (i) {
          i = e.isFunction(i) ? i : function () {
          }, A.refreshModals(), A.hideModal(i)
        }, showModal: function (i) {
          i = e.isFunction(i) ? i : function () {
          }, A.is.animating() || !A.is.active() ? (A.showDimmer(), A.cacheSizes(), A.set.position(), A.set.screenHeight(), A.set.type(), A.set.clickaway(), !C.allowMultiple && b.filter("." + F.active).length > 0 ? (A.debug("Other modals visible, queueing show animation"), A.hideOthers(A.showModal)) : (C.onShow.call(j), C.transition && e.fn.transition !== t && z.transition("is supported") ? (A.debug("Showing modal with css animations"), z.transition({
            debug: C.debug,
        ...
        }, hideModal: function (i, n) {
          i = e.isFunction(i) ? i : function () {
          }, A.debug("Hiding modal"), C.onHide.call(j), (A.is.animating() || A.is.active()) && (C.transition && e.fn.transition !== t && z.transition("is supported") ? (A.remove.active(), z.transition({
            debug: C.debug,
          ...
          i = e.isFunction(i) ? i : function () {
          }, n.length > 0 && (A.debug("Hiding all visible modals"), A.hideDimmer(), n.modal("hide modal", i))
        }, hideOthers: function (i) {
          var n = b.filter(":visible");
          i = e.isFunction(i) ? i : function () {
          }, n.length > 0 && (A.debug("Hiding other modals", b), n.modal("hide modal", i, !0))
          ...
          var o = z.outerHeight();
          (A.cache === t || 0 !== o) && (A.cache = {
            pageHeight: e(n).outerHeight(),
            height: o + C.offset,
            contextHeight: "body" == C.context ? e(i).height() : y.height()
          }), A.debug("Caching modal and container sizes", A.cache)
        }, can: {
          fit: function () {
          ...
          autofocus: function () {
            if (C.autofocus) {
              var e = z.find(":input:visible"), i = e.filter("[autofocus]"), n = i.length > 0 ? i : e;
              n.first().focus()
            }
          }, clickaway: function () {
            ...
            A.verbose("Centering modal on page", A.cache), z.css(A.can.fit() ? {
              top: "",
              marginTop: -(A.cache.height / 2)
          ...
          log: function (e) {
            var i, n, t;
            C.performance && (i = (new Date).getTime(), t = d || i, n = i - t, d = i, m.push({
              Name: e[0],
            ...
            var i = C.name + ":", n = 0;
            d = !1, clearTimeout(A.performance.timer), e.each(m, function (e, i) {
              n += i["Execution Time"]
          ...
          var s, r, c, l = N;
          return n = n || h, o = j || o, "string" == typeof i && l !== t && (i = i.split(/[\. ]/), s = i.length - 1, e.each(i, function (n, o) {
            var a = n != s ? o + i[n + 1].charAt(0).toUpperCase() + i[n + 1].slice(1) : i;
            if (e.isPlainObject(l[a]) && n != s)l = l[a]; else {
              if (l[a] !== t)return r = l[a], !1;
              if (!e.isPlainObject(l[o]) || n == s)return l[o] !== t ? (r = l[o], !1) : !1;
              l = l[o]
            }
