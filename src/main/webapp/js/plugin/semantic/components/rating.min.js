...
!function (e, n, t, a) {
  ...
  e.fn.rating = function (n) {
    var t, i = e(this), o = i.selector || "", r = (new Date).getTime(), s = [], l = arguments[0], c = "string" == typeof l, u = [].slice.call(arguments, 1);
      ...
      g = {
        initialize: function () {
          ...
          mouseenter: function () {
            ...
            var n = e(this), t = g.getRating(), a = x.index(n) + 1, i = "auto" == d.clearable ? 1 === x.length : d.clearable;
            i && t == a ? g.clearRating() : g.setRating(a)
          }
          ...
          var n = e - 1 >= 0 ? e - 1 : 0, t = x.eq(n);
          C.removeClass(f.selected), x.removeClass(f.selected).removeClass(f.active), e > 0 && (g.verbose("Setting current rating to", e), t.prevAll().andSelf().addClass(f.active)), d.onRate.call(y, e)
          ...
          log: function (e) {
            var n, t, a;
            d.performance && (n = (new Date).getTime(), a = r || n, t = n - a, r = n, s.push({
              Name: e[0],
          ...
          var r, s, l, c = R;
          return i = i || u, o = y || o, "string" == typeof n && c !== a && (n = n.split(/[\. ]/), r = n.length - 1, e.each(n, function (t, i) {
            var o = t != r ? i + n[t + 1].charAt(0).toUpperCase() + n[t + 1].slice(1) : n;
            if (e.isPlainObject(c[o]) && t != r)c = c[o]; else {
              if (c[o] !== a)return s = c[o], !1;
              if (!e.isPlainObject(c[i]) || t == r)return c[i] !== a ? (s = c[i], !1) : !1;
              c = c[i]
            }
