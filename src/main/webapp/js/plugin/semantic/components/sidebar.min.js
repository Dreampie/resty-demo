...
!function (e, i, n, t) {
  ...
  e.fn.sidebar = function (o) {
    var r, s = e(this), a = e(i), l = e(n), c = e("html"), u = e("head"), d = s.selector || "", f = (new Date).getTime(), m = [], b = arguments[0], g = "string" == typeof b, v = [].slice.call(arguments, 1), h = i.requestAnimationFrame || i.mozRequestAnimationFrame || i.webkitRequestAnimationFrame || i.msRequestAnimationFrame || function (e) {
        setTimeout(e, 0)
      };
    return s.each(function () {
      var s, p, y, w, k, x, T = e.isPlainObject(o) ? e.extend(!0, {}, e.fn.sidebar.settings, o) : e.extend({}, e.fn.sidebar.settings), C = T.selector, S = T.className, A = T.namespace, P = T.regExp, F = T.error, O = "." + A, E = "module-" + A, H = e(this), L = e(T.context), j = H.children(C.sidebar), D = L.children(C.fixed), z = L.children(C.pusher), M = this, R = H.data(E);
      x = {
        initialize: function () {
          ...
          clickaway: function (e) {
            var i = z.find(e.target).length > 0 || z.is(e.target), n = L.is(e.target);
            i && (x.verbose("User clicked on dimmed page"), x.hide()), n && (x.verbose("User clicked on dimmable context (scaled out page)"), x.hide())
          }, touch: function () {
          ...
          var t = e(i);
          n = e.isFunction(x[n]) ? x[n] : x.toggle, t.length > 0 ? (x.debug("Attaching sidebar events to element", i, n), t.on("click" + O, n)) : x.error(F.notFound, i)
        }, show: function (i) {
          var n = T.useLegacy === !0 ? x.legacyPushPage : x.pushPage;
          if (i = e.isFunction(i) ? i : function () {
            ...
            if (x.refreshSidebars(), T.overlay && (x.error(F.overlay), T.transition = "overlay"), x.refresh(), x.othersActive())if (x.debug("Other sidebars currently visible"), T.exclusive) {
              if ("overlay" != T.transition)return void x.hideOthers(x.show);
              x.hideOthers()
          ...
          var n = T.useLegacy === !0 ? x.legacyPullPage : x.pullPage;
          i = e.isFunction(i) ? i : function () {
          }, (x.is.visible() || x.is.animating()) && (x.debug("Hiding sidebar", i), x.refreshSidebars(), n(function () {
          ...
          var i = j.not(H).filter("." + S.visible), n = i.length, t = 0;
          e = e || function () {
          ...
          var n, t, o = x.get.transition(), r = "safe" == o ? L : "overlay" === o || x.othersActive() ? H : z;
          i = e.isFunction(i) ? i : function () {
          }, "scale down" == T.transition && x.scrollToTop(), x.set.transition(o), x.repaint(), n = function () {
          ...
          var n, t, o = x.get.transition(), r = "safe" == o ? L : "overlay" == o || x.othersActive() ? H : z;
          i = e.isFunction(i) ? i : function () {
          }, x.verbose("Removing context push state", x.get.direction()), x.set.transition(o), x.unbind.clickaway(), x.unbind.scrollLock(), n = function () {
          ...
          var n = H.width(), t = x.get.direction(), o = {};
          n = n || H.width(), i = e.isFunction(i) ? i : function () {
          }, o[t] = n, x.debug("Using javascript to push context", o), x.set.visible(), x.set.transition(), x.set.animating(), T.dimPage && z.addClass(S.dimmed), L.css("position", "relative").animate(o, T.duration, T.easing, function () {
            x.remove.animating(), x.bind.clickaway(), i.call(M)
          })
        }, legacyPullPage: function (i) {
          var n = 0, t = x.get.direction(), o = {};
          n = n || H.width(), i = e.isFunction(i) ? i : function () {
          }, o[t] = "0px", x.debug("Using javascript to pull context", o), x.unbind.clickaway(), x.set.animating(), x.remove.visible(), T.dimPage && !x.othersActive() && z.removeClass(S.dimmed), L.css("position", "relative").animate(o, T.duration, T.easing, function () {
          ...
          direction: function () {
            ...
            var e, i = x.get.direction();
            return e = x.is.mobile() ? "auto" == T.mobileTransition ? T.defaultTransition.mobile[i] : T.mobileTransition : "auto" == T.transition ? T.defaultTransition.computer[i] : T.transition, x.verbose("Determined transition", e), e
          ...
          ie: function () {
            ...
            for (var s in r)o.style[s] !== t && (o.style[s] = "translate3d(1px,1px,1px)", e = i.getComputedStyle(o).getPropertyValue(r[s]));
            return n.body.removeChild(o), !(e !== t && e.length > 0 && "none" !== e)
          }, ios: function () {
            var e = navigator.userAgent, i = e.match(P.ios);
            return i ? (x.verbose("Browser was found to be iOS", e), !0) : !1
          }, mobile: function () {
            var e = navigator.userAgent, i = e.match(P.mobile);
            return i ? (x.verbose("Browser was found to be mobile", e), !0) : (x.verbose("Browser is not mobile, using regular transition", e), !1)
          }, hidden: function () {
            return !x.is.visible()
          }, visible: function () {
          ...
          log: function (e) {
            var i, n, t;
            T.performance && (i = (new Date).getTime(), t = f || i, n = i - t, f = i, m.push({
              Name: e[0],
            ...
            var i = T.name + ":", n = 0;
            f = !1, clearTimeout(x.performance.timer), e.each(m, function (e, i) {
              n += i["Execution Time"]
          ...
          var s, a, l, c = R;
          return n = n || v, o = M || o, "string" == typeof i && c !== t && (i = i.split(/[\. ]/), s = i.length - 1, e.each(i, function (n, o) {
            var r = n != s ? o + i[n + 1].charAt(0).toUpperCase() + i[n + 1].slice(1) : i;
            if (e.isPlainObject(c[r]) && n != s)c = c[r]; else {
              if (c[r] !== t)return a = c[r], !1;
              if (!e.isPlainObject(c[o]) || n == s)return c[o] !== t ? (a = c[o], !1) : (x.error(F.method, i), !1);
              c = c[o]
            }
    ...
    easeInOutQuint: function (e, i, n, t, o) {
