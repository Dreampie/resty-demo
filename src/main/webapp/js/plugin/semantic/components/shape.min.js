...
!function (e, t, i, n) {
  ...
  e.fn.shape = function (a) {
    var o, r = e(this), s = (e("body"), (new Date).getTime()), d = [], l = arguments[0], u = "string" == typeof l, g = [].slice.call(arguments, 1), c = t.requestAnimationFrame || t.mozRequestAnimationFrame || t.webkitRequestAnimationFrame || t.msRequestAnimationFrame || function (e) {
        setTimeout(e, 0)
      };
    return r.each(function () {
      var t, f, m, p = r.selector || "", h = e.extend(!0, {}, e.fn.shape.settings, a), v = h.namespace, b = h.selector, x = h.error, y = h.className, S = "." + v, w = "module-" + v, C = e(this), W = C.find(b.sides), z = C.find(b.side), k = !1, T = this, A = C.data(w);
      m = {
        initialize: function () {
          ...
          {
            var e = W.get(0) || i.createElement("div");
            e.offsetWidth
          }
          ...
          defaultSide: function () {
            ...
            e = e || h.duration, e = "number" == typeof e ? e + "ms" : e, m.verbose("Setting animation duration", e), W.add(z).css({
            ...
            var e = C.clone().addClass(y.loading), t = e.find("." + h.className.active), i = k ? e.find(b.side).eq(k) : t.next(b.side).length > 0 ? t.next(b.side) : e.find(b.side).first(), n = {};
            t.removeClass(y.active), i.addClass(y.active), e.insertAfter(C), n = {
              width: i.outerWidth(),
              height: i.outerHeight()
            }, e.remove(), C.css(n), m.verbose("Resizing stage to fit new content", n)
          }, nextSide: function (e) {
          ...
          log: function (e) {
            var t, i, n;
            h.performance && (t = (new Date).getTime(), n = s || t, i = t - n, s = t, d.push({
              Name: e[0],
          ...
          var r, s, d, l = A;
          return i = i || g, a = T || a, "string" == typeof t && l !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (i, a) {
