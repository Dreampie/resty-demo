...
!function (e, t, n, i) {
  ...
  e.fn.form = function (t, r) {
    var o, a = e(this), s = e.extend(!0, {}, e.fn.form.settings, r), l = e.extend({}, e.fn.form.settings.defaults, t), c = s.namespace, u = s.metadata, d = s.selector, f = s.className, p = (s.error, "." + c), v = "module-" + c, m = a.selector || "", h = (new Date).getTime(), g = [], b = arguments[0], k = "string" == typeof b, y = [].slice.call(arguments, 1);
    return a.each(function () {
      var t, r = e(this), c = e(this).find(d.field), x = e(this).find(d.group), w = e(this).find(d.message), E = (e(this).find(d.prompt), e(this).find(d.submit)), C = e(this).find(d.clear), S = e(this).find(d.reset), R = [], F = !1, z = this, T = r.data(v);
      t = {
        initialize: function () {
          ...
          s.keyboardShortcuts && c.on("keydown" + p, t.event.field.keydown), r.on("submit" + p, t.validate.form), c.on("blur" + p, t.event.field.blur), t.attachEvents(E, "submit"), t.attachEvents(S, "reset"), t.attachEvents(C, "clear"), c.each(function () {
            ...
            e(this).on(i + p, t.event.field.change)
          })
        }, clear: function () {
          c.each(function () {
            var n = e(this), i = n.parent(), r = n.closest(x), o = r.find(d.prompt), a = n.data(u.defaultValue) || "", s = i.is(d.uiCheckbox), l = i.is(d.uiDropdown), c = r.hasClass(f.error);
            c && (t.verbose("Resetting error on field", r), r.removeClass(f.error), o.remove()), l ? (t.verbose("Resetting dropdown value", i, a), i.dropdown("clear")) : s ? i.checkbox("uncheck") : (t.verbose("Resetting field value", n, a), n.val(""))
          })
        }, reset: function () {
          c.each(function () {
            var n = e(this), i = n.parent(), r = n.closest(x), o = r.find(d.prompt), a = n.data(u.defaultValue) || "", s = i.is(d.uiCheckbox), l = i.is(d.uiDropdown), c = r.hasClass(f.error);
            c && (t.verbose("Resetting error on field", r), r.removeClass(f.error), o.remove()), l ? (t.verbose("Resetting dropdown value", i, a), i.dropdown("restore defaults")) : s ? (t.verbose("Resetting checkbox value", i, a), i.checkbox(a === !0 ? "check" : "uncheck")) : (t.verbose("Resetting field value", n, a), n.val(a))
          })
          ...
          field: {
            keydown: function (n) {
              ...
              r == o.escape && (t.verbose("Escape key pressed blurring field"), i.blur()), !n.ctrlKey && r == o.enter && i.is(d.input) && i.not(d.checkbox).length > 0 && (E.addClass(f.pressed), F || (i.one("keyup" + p, t.event.field.keyup), t.submit(), t.debug("Enter pressed on input submitting form")), F = !0)
            }, keyup: function () {
              F = !1, E.removeClass(f.pressed)
            }, blur: function () {
              var n = e(this), i = n.closest(x);
          ...
          changeEvent: function (e) {
            ...
            var n, i = [];
            return i.push(e), n = t.get.values.call(z, i), n[e]
          }, values: function (n) {
            var i = e.isArray(n) ? t.get.fields(n) : c, r = {};
            return i.each(function (n, i) {
              var o = e(i), a = (o.prop("type"), o.prop("name")), s = o.val(), l = o.is(d.checkbox), c = o.is(d.radio), u = -1 !== a.indexOf("[]"), f = l ? o.is(":checked") : !1;
              if (a)if (u)if (a = a.replace("[]", ""), r[a] || (r[a] = []), l) {
                if (!f)return t.debug("Omitted unchecked checkbox", o), !0;
                r[a].push(s)
          ...
          prompt: function (n, o) {
            var a = t.get.field(n), l = a.closest(x), c = l.children(d.prompt), u = 0 !== c.length;
            o = "string" == typeof o ? [o] : o, t.verbose("Adding field error state", n), l.addClass(f.error), s.inline && (u || (c = s.templates.prompt(o), c.appendTo(l)), c.html(o[0]), u ? t.verbose("Inline errors are disabled, no inline error added", n) : s.transition && e.fn.transition !== i && r.transition("is supported") ? (t.verbose("Displaying error with css transition", s.transition), c.transition(s.transition + " in", s.duration)) : (t.verbose("Displaying error with fallback javascript animation"), c.fadeIn(s.duration)))
          }, errors: function (e) {
            t.debug("Adding form error messages", e), w.html(s.templates.error(e))
          }
        }, remove: {
          prompt: function (n) {
            var o = t.get.field(n.identifier), a = o.closest(x), l = a.children(d.prompt);
          ...
          success: function () {
            ...
            var i = {};
            return i[e] = n, t.set.values.call(z, i)
          }, values: function (n) {
            e.isEmptyObject(n) || (e.each(n, function (n, i) {
              var r, o = t.get.field(n), a = o.parent(), s = e.isArray(i), l = a.is(d.uiCheckbox), c = a.is(d.uiDropdown), u = o.is(d.radio) && l, f = o.length > 0;
              f && (s && l ? (t.verbose("Selecting multiple", i, o), a.checkbox("uncheck"), e.each(i, function (e, t) {
          ...
          form: function (n) {
            var o = !0;
            return F ? !1 : (R = [], e.each(l, function (e, n) {
            ...
            return r.prop("disabled") ? (t.debug("Field is disabled. Skipping", n.identifier), o = !0) : n.optional && "" === e.trim(r.val()) ? (t.debug("Field is optional and empty. Skipping", n.identifier), o = !0) : n.rules !== i && e.each(n.rules, function (e, i) {
            ...
            var o, a, l = t.get.field(n.identifier), c = r.type, u = e.trim(l.val() + ""), d = /\[(.*)\]/i, f = d.exec(c), p = !0;
            return f !== i && null !== f ? (o = "" + f[1], a = c.replace(f[0], ""), p = s.rules[a].call(z, u, o)) : p = s.rules[c].call(l, u), p
          }
          ...
          log: function (e) {
            var n, i, r;
            s.performance && (n = (new Date).getTime(), r = h || n, i = n - r, h = n, g.push({
              Name: e[0],
            ...
            var n = s.name + ":", r = 0;
            h = !1, clearTimeout(t.performance.timer), e.each(g, function (e, t) {
              r += t["Execution Time"]
          ...
          var a, s, l, c = T;
          return n = n || y, r = z || r, "string" == typeof t && c !== i && (t = t.split(/[\. ]/), a = t.length - 1, e.each(t, function (n, r) {
            var o = n != a ? r + t[n + 1].charAt(0).toUpperCase() + t[n + 1].slice(1) : t;
            if (e.isPlainObject(c[o]) && n != a)c = c[o]; else {
              if (c[o] !== i)return s = c[o], !1;
              if (!e.isPlainObject(c[r]) || n == a)return c[r] !== i ? (s = c[r], !1) : !1;
              c = c[r]
            }
    ...
    rules: {
      checked: function () {
        ...
        var r, o = e(this);
        return o.find("#" + n).length > 0 ? r = o.find("#" + n).val() : o.find('[name="' + n + '"]').length > 0 ? r = o.find('[name="' + n + '"]').val() : o.find('[data-validate="' + n + '"]').length > 0 && (r = o.find('[data-validate="' + n + '"]').val()), r !== i ? t.toString() == r.toString() : !1
