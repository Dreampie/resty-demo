...
!function (n, e, i, t) {
  ...
  n.fn.transition = function () {
    {
      var a, o = n(this), s = o.selector || "", r = (new Date).getTime(), l = [], u = arguments, m = u[0], c = [].slice.call(arguments, 1), d = "string" == typeof m;
    ...
    return o.each(function (e) {
      var f, p, g, v, b, y, h, w, C, A, T, S = n(this), x = this;
      T = {
        initialize: function () {
          ...
          var n = S.parent(), e = S.next();
          0 === e.length ? S.detach().appendTo(n) : S.detach().insertBefore(e)
        }, repaint: function () {
          T.verbose("Repainting element");
          x.offsetWidth
        }, delay: function (n) {
          var i, a = f.reverse === !0, s = "auto" == f.reverse && T.get.direction() == v.outward;
          n = typeof n !== t ? n : f.interval, i = a || s ? (o.length - e) * f.interval : e * f.interval, T.debug("Delaying animation by", i), setTimeout(T.animate, i)
        }, animate: function (n) {
          if (f = n || f, !T.is.supported())return T.error(g.support), !1;
          if (T.debug("Preparing animation", f.animation), T.is.animating()) {
            if (f.queue)return !f.allowRepeats && T.has.direction() && T.is.occurring() && T.queuing !== !0 ? T.debug("Animation is currently occurring, preventing queueing same animation", f.animation) : T.queue(f.animation), !1;
            if (!f.allowRepeats && T.is.occurring())return T.debug("Animation is already occurring, will not execute repeated animation", f.animation), !1;
            T.debug("New animation started, completing previous early", f.animation), T.complete()
          }
          ...
          animating: function (n) {
            ...
            e = e || f.duration, e = "number" == typeof e ? e + "ms" : e, (e || 0 === e) && (T.verbose("Setting animation duration", e), S.css({
            ...
            var n = T.get.style(), e = T.get.displayType(), i = n + "display: " + e + " !important;";
            S.css("display", ""), T.refresh(), S.css("display") !== e && (T.verbose("Setting inline visibility to", e), S.attr("style", i))
          }, direction: function () {
          ...
          displayType: function (n) {
            ...
            S.removeClass(f.animation), T.remove.direction(), T.cache = {
          ...
          settings: function (e, i, t) {
            ...
            return n = n || f.duration, n === !1 && (n = S.css("animation-duration") || 0), "string" == typeof n ? n.indexOf("ms") > -1 ? parseFloat(n) : 1e3 * parseFloat(n) : n
          ...
          transition: function (e) {
            var i, a, o, s, r, l = S.attr("class"), u = S.prop("tagName"), m = f.animation, c = T.get.transitionExists(m);
            if (c === t || e) {
              if (T.verbose("Determining whether animation exists"), i = n("<" + u + " />").addClass(l).insertAfter(S), a = i.addClass(m).removeClass(v.inward).removeClass(v.outward).addClass(v.animating).addClass(v.transition).css(w), o = i.addClass(v.inward).css(w), r = i.attr("class", l).removeAttr("style").removeClass(v.hidden).removeClass(v.visible).show().css("display"), T.verbose("Determining final display state", r), T.save.displayType(r), i.remove(), a != o)T.debug("Direction exists for animation", m), s = !0; else {
                if ("none" == a || !a)return void T.debug("No animation defined in css", m);
                T.debug("Static animation found", m, r), s = !1
              }
          ...
          log: function (n) {
            var e, i, t;
            f.performance && (e = (new Date).getTime(), t = r || e, i = e - t, r = e, l.push({
              Name: n[0],
            ...
            var e = f.name + ":", i = 0;
            r = !1, clearTimeout(T.performance.timer), n.each(l, function (n, e) {
              i += e["Execution Time"]
          ...
          var s, r, l, u = p;
          return i = i || c, o = x || o, "string" == typeof e && u !== t && (e = e.split(/[\. ]/), s = e.length - 1, n.each(e, function (i, a) {
            var o = i != s ? a + e[i + 1].charAt(0).toUpperCase() + e[i + 1].slice(1) : e;
            if (n.isPlainObject(u[o]) && i != s)u = u[o]; else {
              if (u[o] !== t)return r = u[o], !1;
              if (!n.isPlainObject(u[a]) || i == s)return u[a] !== t ? (r = u[a], !1) : !1;
              u = u[a]
            }
